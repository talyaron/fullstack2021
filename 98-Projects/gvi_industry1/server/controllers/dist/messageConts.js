...
exports.getMessages = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var sender_1, allMessages, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                sender_1 = req.body.sender;
                return [4 /*yield*/, messageModel_1["default"].find({})];
            case 1:
                allMessages = _a.sent();
                allMessages = allMessages.filter(function (message) { return message.sender.userId === sender_1.userId || message.recipient.userId === sender_1.userId; });
                res.send({ allMessages: allMessages, ok: true });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
...
exports.uploadFile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, docLink, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                result = req.body.result;
                return [4 /*yield*/, cloudinary.uploader.upload(result, {
                        folder: "docs"
                    })];
            case 1:
                docLink = _a.sent();
                return [4 /*yield*/, docLink];
            case 2:
                _a.sent();
                res.send({ ok: true, docLink: docLink });
                return [3 /*break*/, 4];
            case 3:
                error_2 = _a.sent();
