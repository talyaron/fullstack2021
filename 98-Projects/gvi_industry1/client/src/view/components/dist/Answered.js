...
var ReqUserCardAnswer_1 = require("./ReqUserCardAnswer");
var Answered = function () {
    var _a = react_1.useState([]), ansUsers = _a[0], setAnsUsers = _a[1];
    ...
    React.createElement("div", { className: "selectedPage" },
        ...
        React.createElement("div", { className: "selectedPage__wrapper" },
            React.createElement(ReqUserCardAnswer_1["default"], { ansUsers: ansUsers }))));
};
