...
var SelectedUserCard_1 = require("../Components/SelectedUserCard");
var SelectedUsers = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, axios_1["default"].post('/api/users/get-selected-users', { _id: _id, type: type })];
                    case 2:
                        users = _a.sent();
    ...
    return (React.createElement("div", { className: "selectedPage" },
        React.createElement("h5", { className: "selectedPage__title" },
            ...
            type,
            " ",
            React.createElement(Star_1["default"], { id: 'star' }),
            " "),
        React.createElement("div", { className: "selectedPage__wrapper" },
            React.createElement(SelectedUserCard_1["default"], { selectedUsers: selectedUsers }))));
};
