...
const RequestCard = (props: CardReqProps) => {
      ...
      {requestUsers.map((item: any, i: any) =>
        <div className="card_req" key={i}>
           <Popup trigger={<img id='envelope' src={`${"https://mpng.subpng.com/20180606/xbk/kisspng-email-clip-art-open-envelope-5b1885b6f1a5f1.8092976715283337509898.jpg"}`} alt="" />} position="right center">
            <div >Hi! I a interested in learning more about your venture and would like to see if we an collaborate</div></Popup>

          <div className="card_req__photo">
          ...
          <div className="card_req__center">
            <p>{item['name']['first']} {item['name']['last']}</p>

            <div className="card_req__flex">
