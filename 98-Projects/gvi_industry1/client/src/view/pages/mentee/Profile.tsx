...
export function Profile (props:ProfileProps) {
  ...
  return (
    <div className='profile'>
        ...
        <div className='profile_contactInfo-edit' style={{gridColumn:'9/11',gridRow:'2/3'}} onClick={editAddressDetails}>✏️</div>
        ...
        <div className='profile_contactInfo-address'>
            <p style={{gridRow:1,gridColumn:'1/3',fontSize:'15px',textAlign:'center'}}>{userDemo.coutry},</p>
            <p style={{gridRow:1,gridColumn:'3/5',fontSize:'15px'}}>{userDemo.city}</p>
            <p style={{gridRow:2,fontSize:'15px',gridColumn:'1/6',textAlign:'center'}}>{userDemo.address}</p>
            </div>
            <p className='profile_contactInfo-email'>{userDemo.email}</p>
            <p className='profile_contactInfo-phone'>{userDemo.phone}</p>
            <a className='profile_contactInfo-linkDinLink' style={{gridColumn:'3/4',gridRow:'9/11',height:'75%',width:'150%'}} 
            href="http://linkdin.com"><img style={{height:'100%',width:'100%'}} 
