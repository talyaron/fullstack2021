...
export function Profile (props:ProfileProps) {
     ...
     const [userInitiative , setInitiative] = useState()
     ...
     useEffect(() => {
      ...
      async function getInitiative(){
        ...
        console.log(data);
        setInitiative(data.userInitiative)
      }
  ...
  return (
    <div className='profile'>
        ...
        <div className='profile_companyDetails_header'>
                ...
                <ProffesionalDetails userInitiative={userInitiative} mentorDetails={mentorDetails} 
                isMentee={isMentee} />}
