...
var SelectedMentor = function () {
    ...
    var userDetails = {
        ...
        country: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGZsu8Q5D3z58o9l6SvOTnapSCWpjVQMApu-vQsQobWw&s",
    ...
    return (React.createElement("div", { className: "card" },
        React.createElement("div", { className: "card__photo" },
            React.createElement("img", { src: "" + userDetails.img, alt: "" })),
        React.createElement("div", { className: "card__center" },
            React.createElement("p", { className: "card__name" },
                " ",
                userDetails.name),
            React.createElement("div", { className: "card__flex" },
                React.createElement("img", { src: "" + userDetails.country, alt: "" })),
            React.createElement("p", { className: "card__company" }, userDetails.companies),
            React.createElement("p", { className: "card__profession" }, userDetails.profession)),
        React.createElement("div", { className: "card__star" })));
};
exports["default"] = SelectedMentor;
