...
const users: Array<UserProps> = [
  {
    ...
    posts: [
      {postId:uid(),datePosted:'28-10-2021',link:'https://github.com/ShaniRom',imgUrl:'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/INT_logo.png/1135px-INT_logo.png', topic:"web development", description: "Started studying in INT!" },
      {postId:uid(),datePosted:'18-5-1010',link:'https://github.com/talyaron/fullstack2021/tree/main/98-Projects/Mongoose-Project/Airbnb/airbnb-localStorage',imgUrl:'https://www.pngkey.com/png/full/60-605967_airbnb-logo-png.png', topic: "mongo+nodeJS" , description: "Me and my group made a clone of the airbnb app! click link to see it " },
      {postId:uid(),datePosted:'25-5-1010',link:'https://github.com/talyaron/fullstack2021/tree/main/98-Projects/React/shani',imgUrl:'https://i0.wp.com/www.primefaces.org/wp-content/uploads/2017/09/feature-react.png?ssl=1', topic: "react", description: "For my first react project I decided to make a blog that can act as a resume showing my skills and links to other projects.Click the link to check the code out " },
    ],
  }
