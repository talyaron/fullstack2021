...
function handleRenderHome(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var userId, data, userInfo, user, name, lowTasks, mediumTasks, highTasks, arr, low, medium, high;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ev.preventDefault();
...
function renderTasks(currentUsersTasks, currentPage) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function handleTaskUpdate(ev) {
            return __awaiter(this, void 0, void 0, function () {
                var color, title, urgency, description, location, date, taskId, userId, data, currentUsersTasks_1, error_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ev.preventDefault();
                        ...
                        case 2:
                            data = (_a.sent()).data;
                            currentUsersTasks_1 = data.currentUsersTasks;
                            renderTasks(currentUsersTasks_1, "RecentlyCreated");
                            closeTaskModal();
                            return [3 /*break*/, 4];
                        case 3:
                            error_4 = _a.sent();
        ...
        function handleTaskCheck(ev) {
            return __awaiter(this, void 0, void 0, function () {
                var timeChecked, taskId, userId, data, currentUsersTasks_2, error_5;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                        ...
                        case 1:
                            data = (_a.sent()).data;
                            currentUsersTasks_2 = data.currentUsersTasks;
                            renderTasks(currentUsersTasks_2, "RecentlyCreated");
                            return [3 /*break*/, 3];
                        case 2:
                            error_5 = _a.sent();
        ...
        function handleTaskDelete(ev) {
            return __awaiter(this, void 0, void 0, function () {
                var taskId, userURL, data, currentUsersTasks_3, currentPage_1, error_6;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 2:
                            data = (_a.sent()).data;
                            currentUsersTasks_3 = data.currentUsersTasks, currentPage_1 = data.currentPage;
                            renderTasks(currentUsersTasks_3, currentPage_1);
                            return [3 /*break*/, 4];
                        case 3:
                            error_6 = _a.sent();
