        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.post('/add-product', { pic: pic, title: title, description: description, price: price, category: category })];
                case 1:
                    data = (_b.sent()).data;
...
function handleGetProducts() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios.get('/get-products')];
                case 1:
                    data = (_a.sent()).data;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.patch('/update-product', { gameId: gameId, newImg: newImg, newTitle: newTitle })];
                case 1:
                    data = (_a.sent()).data;
                    products = data.products;
                    renderProducts(products);
