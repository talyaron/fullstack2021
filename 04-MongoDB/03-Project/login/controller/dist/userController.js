...
exports.login = exports.updateUser = exports.addUser = exports.getAllUsers = void 0;
var userModel_1 = require("../model/userModel");
function getAllUsers(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userInfo, users, error_1;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                newUser = new userModel_1["default"]({ username: username, password: password });
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, userModel_1["default"].updateOne({ _id: userId }, { role: role })];
            case 1:
                users = _b.sent();
                res.send({ ok: true, users: users });
                return [3 /*break*/, 3];
