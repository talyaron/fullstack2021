        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.post('/add-user', { name: name, password: password })];
                case 1:
                    data = (_b.sent()).data;
                    console.log(data);
                    getUsers();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log(userId);
                    name = e.target.value;
                    return [4 /*yield*/, axios.patch('/update-user', { userId: userId, name: name })];
                case 1:
                    data = (_a.sent()).data;
                    console.log(data);
                    getUsers();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    password = password.value;
                    console.log(name, password);
                    return [4 /*yield*/, axios.post('/login-user', { name: name, password: password })];
                case 1:
                    data = (_b.sent()).data;
                    console.log(data);
                    return [2 /*return*/];
