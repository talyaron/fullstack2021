...
app.get("/getArticale", function (req, res) {
  console.log(req.query);
  var search = req.query.search;
  var year = req.query.year;
  var type = req.query.type; // const regex = new RegExp(search, "i");
  ...
  setTimeout(function () {
    ...
    if (year) {
      console.log(year); // const filterUsers = data.filter((user) => user.year === year)
      // console.log(filterUsers);

      res.send(articales);
    } else if (type) {
      console.log(type); // const filters = data.filter((user) => user.type === type)
      // console.log(filters);
