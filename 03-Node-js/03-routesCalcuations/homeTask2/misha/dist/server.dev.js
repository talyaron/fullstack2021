...
var article = [{
  name: 'p1.',
  content_title: "1. Adopt a \u201Cfixed volume\u201D approach to productivity",
  ...
  name: 'p3.',
  content_title: "3. Decide in advance what to fail at",
  ...
  name: 'p4.',
  content_title: "4. Focus on what you\u2019ve already completed, not just what\u2019s left to do",
  ...
  name: "p5.",
  content_title: "5. Consolidate your caring",
  ...
  name: "p6.",
  content_title: "6. Embrace boring and single-purpose technology",
  ...
  name: "p7.",
  content_title: "7. Seek out novelty in the mundane",
  ...
  name: "p8.",
  content_title: "8. Be a researcher in relationships",
  ...
  name: "p9.",
  content_title: "9. Cultivate instantaneous generosity",
  ...
  name: "p10.",
  content_title: "10. Practice doing nothing",
...
app.get('/get-article', function (req, res) {
  var term = req.query.terms;
  var filteredArticle = filterArticle(term);
...
function filterArticle(term) {
  if (term) {
    ...
    return article.filter(function (paragraph) {
      return regex.test(paragraph.name);
    });
  } else {
    return [];
  }
