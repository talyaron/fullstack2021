...
const article = [
    {name: 'p1', content_title: `1. Adopt a “fixed volume” approach to productivity`, content: `
    ...
    {name: 'p2', content_title: `2. Serialize`, content:`
    ...
    {name: 'p3', content_title: `3. Decide in advance what to fail at`, content:`
    ...
    {name: 'p4', content_title: `4. Focus on what you’ve already completed, not just what’s left to do`, content:`
    ...
    {name: `p5`, content_title: `5. Consolidate your caring`, content:`
    ...
    {name: `p6`, content_title: `6. Embrace boring and single-purpose technology`, content:`
    ...
    {name:`p7`, content_title: `7. Seek out novelty in the mundane`, content:`
    ...
    {name:`p8`, content_title: `8. Be a researcher in relationships`, content:`
    ...
    {name: `p9`, content_title: `9. Cultivate instantaneous generosity` , content:`
    ...
    {name:`p10`, content_title: `10. Practice doing nothing`, content:`
...
app.get('/get-article', function (req, res) {
    ...
    let filteredArticle = filterArticle(term)
    res.send(filteredArticle)

});

function filterArticle(term){
    if(term){
        const regex = new RegExp(term, "i");
        return article.filter((paragraph) => regex.test(paragraph.name));
    }
    else{
        return [];
    }
