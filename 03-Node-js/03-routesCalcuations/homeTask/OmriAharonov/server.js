...
const cars = [
    ...
    {img:'https://cdn.hswstatic.com/gif/1961-chevrolet-impala-ss-409-1.jpg', name:'Chevrolet Impala SS', year:'1961'},
    {img:'https://i.pinimg.com/736x/f0/4b/37/f04b37e0b56a5fe7ee422683cad40837--dart-car-dodge-dart.jpg', name:'Dodge Dart', year:'1962'},
    {img:'https://www.totallycars.club/wp-content/uploads/2019/01/american-muscle-cars-buick-riviera-gs-15485340484c8pl-700x525.jpg', name:'Buick Riviera GS', year:'1965'},
    {img:'https://www.totallycars.club/wp-content/uploads/2020/05/1590335640pcl48-700x394.jpg', name:'Ford Galaxie 427', year:'1963'}
...
app.get('/muscleCars' , (req, res) => {
    ...
    res.send(filterdCar) 
        ...
        const filterdyear = cars.filter(auto => auto.year === year); 
