...
function handleAddToCart(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios.patch('/add-to-cart', { id: id })];
                case 1:
                    data = (_a.sent()).data;
                    return [2 /*return*/];
            }
...
function renderToRegister(usernameValue) {
    ...
    var farDiv = document.querySelector('.farDiv');
    ...
    setTimeout(function () {
        container.style.visibility = 'hidden';
        icons.forEach(function (icon) { return icon.style.visibility = 'hidden'; });
...
function showLoginForm(event) {
    return __awaiter(this, void 0, void 0, function () {
        var loginUserName, passwordValue, container2Root, farDiv;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    farDiv = document.querySelector('.farDiv');
