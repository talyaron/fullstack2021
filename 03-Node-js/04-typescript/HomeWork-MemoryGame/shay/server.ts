...
const games:Array<card> = [{photo:"https://publish.one37pm.net/wp-content/uploads/2020/05/spiderman-mobile.jpg", pairdId:1 ,id:"" },
...
app.post("/add-card", (req, res) => {
  ...
  function addPhoto(photo:string ,pairdId:number){
