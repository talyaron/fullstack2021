...
function createCard(person) {
    var cardTable = "<div class=card>" + "<span id=logo></span>" + "<div class=photoWrapper>" + "<span id=background>+</span>" + "<div id=text\">" + ("<h2>" + person.name + "</h2>") + ("<p>" + person.description + "</p>") + "</div>" + "</div>" + "</div>";
