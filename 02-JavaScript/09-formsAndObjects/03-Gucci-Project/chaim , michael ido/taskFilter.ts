...
function showOptions(box:any, boxId:string) {
  ...
  const sortANDfilterBtnsTshirts = document.getElementById(
    "sortANDfilterBtnsTshirts"
  );
  const sortANDfilterBtnsShoes = document.getElementById(
    "sortANDfilterBtnsShoes"
  );
  const sortANDfilterBtnsPants = document.getElementById(
    "sortANDfilterBtnsPants"
  );
