...
const z = window.prompt ('please choose a number and you will get the month..')
function numToMonth(z){
    if(z==1)
    return 'The month is January'
    else if(z==2)
    return 'The month is Februery'
    else if(z==3)
    ...
    return 'Error,there isnt such a month'
}
...
function dollarToNis(d,n){
   ...
   let q = dollarToNis(3.13,10);

    console.log(`10 dollar is ${q} shekel`);
