...
function handleclickd(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios.get("/me")];
                case 1:
                    data = (_a.sent()).data;
                    renderalldata(data);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.post("/add-student", { name: name, age: age })];
                case 1:
                    data = (_a.sent()).data;
                    renderalldata(data);
                    ev.target.reset();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.patch("/change-name", { id: id, name: value })];
                case 1:
                    data = (_a.sent()).data;
                    renderalldata(data);
                    return [3 /*break*/, 3];
