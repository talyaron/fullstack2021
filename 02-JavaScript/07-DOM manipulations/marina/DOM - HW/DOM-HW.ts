...
const title: any = document.getElementById ('theTitle');
console.log (title);
...
const wrapper: any = document.querySelector ('.theWrapper');
console.dir (wrapper);
...
const boxOne: any = document.querySelector('.one');
console.dir (boxOne);
...
const boxTwo: any = document.querySelector ('.two');
console.dir (boxTwo);
...
const boxThree: any = document.querySelector ('.three');
...
const boxFour: any = document.querySelector ('.four');
console.dir (boxFour);
...
const GoodbyText:any = document.querySelector ('p');
