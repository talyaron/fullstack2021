...
function picOneEnter() {
    personName.innerText = 'Bob Asnafy';
    personName.style.opacity = '1';
}
function picOneLeave() {
    personName.innerText = '( please hover image )';
    personName.style.opacity = '0.5';
}
...
function picTwoEnter() {
    personName.innerText = 'Jasmine Asnafy';
    personName.style.opacity = '1';
}
...
function picThreeEnter() {
    personName.innerText = 'Quasimodo Notre Dame De Paris Asnafy';
    personName.style.opacity = '1';
}
...
function picFourEnter() {
    personName.innerText = 'Winnie Asnafy';
    personName.style.opacity = '1';
}
...
function picFiveEnter() {
    personName.innerText = 'Snoopy Asnafy';
    personName.style.opacity = '1';
}
...
function picSixEnter() {
    personName.innerText = 'Simba Asnafy';
    personName.style.opacity = '1';
}
...
function picSevenEnter() {
    personName.innerText = 'Dora Asnafy';
    personName.style.opacity = '1';
}
