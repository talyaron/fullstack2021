...
const video = document.getElementById ('displayVD') as HTMLVideoElement
const btnsInfo = document.querySelectorAll('.main_box-btnInfo')
const sourceVideo = document.getElementById('sourceVideo')

// id's buttons  
const btnGTAinfo = document.getElementById('btnGTA')
const btnCODinfo = document.getElementById('btnCOD')
const btnNBAinfo = document.getElementById('btnNBA')
const btnFIFAinfo = document.getElementById('btnFIFA')
const btnSPIDYinfo = document.getElementById('btnSpidy')
const btnFORTinfo = document.getElementById('btnFort')
...
let nbaBackground;
let fifaBackground;
let fortniteBackground;
let spidermanBackground;
let codBackground;
...
function showButtons(box):void{
    const id:string = box.target.id
...
function showDescription(btn):void{
    const id:string = btn.target.id
